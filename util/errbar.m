...
% plots error bars without horizontal tees
%   x: x axis data vector
%   y: y axis data vectors
%   err: vector with error estimates. A two-row vectors will be
%        interepreted as asymetrical lower and upper error limits
%   cl: color of plot (default 'k')
%   linew: linewidth (default .75)
%   horizFlag: boolean to plot horizontal instead of vertical bars (default false)
%   linestyle: standard matlab input, default '-'
