classdef analysisParams
    ...
    properties (Constant)
        ...
        % paths (empty entries should be filled with local machine paths)
        savepath                = []; % for inactivation data
        savepathBehav           = []; % for behavioral data
        gridpath                = []; % where inactivation grids are saved
        ...
        mice            = { 'wt12';'wt13';'wt11';'wt6';'vg1';'vg2';'vg3';'vg4';'vg5';       ...
                            ...
                            'vg36';'vg37';'vg38';'vg41';'vg42';'vg39';'vg40'
                          }; %;'wt5';
        ...
        areaCl          = [[0 129 59]./255;[0 224 205]./255;[0 116 225]./255; ...
                           [231 118 22]./255;[231 179 42]./255;[172 51 59]./255;[207  79 223]./255];
        multiCl         = { ...
                            [  .750      .750      .750], ...
                            [  .500      .500      .500], ...
                            [  .250      .250      .250], ...
